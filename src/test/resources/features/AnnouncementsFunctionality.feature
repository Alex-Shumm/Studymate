...
#      | Dear Students! You have mock interview in upcoming Friday! 03/20/2025 | Batch7 |
  ...
  Scenario: Validate created announcement
    Then User validates type 'Hidden', for whom 'Batch8', who created 'ADMIN', text 'Dear Students! You have mock interview in upcoming Friday! 03/20/2025' and data '03.22.25'
